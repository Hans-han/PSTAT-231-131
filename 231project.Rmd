...
Looking at the R-Squared of the test set. Of the 4 models, the Boost model has the highest R squared 0.897, much higher than the others.

# Conlcusion
From our exploratory data analysis and model fitting part, we can know that the Boost model performs much better than the other methods. Of all these methods, the LASSO regression perform the worst. Also we should have in mind that DXY is the most significant predictors.
